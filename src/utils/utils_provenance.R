#################################################################
# UTILITIES TO TRACK PROVENANCE, I.E. WHERE FILES CAME FROM
#################################################################

# add information on most recent Git commit to a given file
...
# add R session information to a given file
