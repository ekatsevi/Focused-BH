...
GO_reduced_graph_file = sprintf("%s/data/processed/GO/GO_reduced_graph.Rda", base_dir)
...
############# CREATE GO GRAPH FOR REAL DATA ANALYSIS ###################
# remove terms with no annotations and terms that were not present in the 
# version of GO used for REVIGO
...
############# CREATE GO GRAPH FOR NUMERICAL EXPERIMENTS ###################
